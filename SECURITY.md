...
- GitHub Security Advisory draft: <https://github.com/Nick2bad4u/stylelint-plugin-font/security/advisories/new>
...
- Keep `stylelint-plugin-font`, Stylelint, and dependencies updated.
